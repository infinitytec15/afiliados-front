                ...
                <div className="space-y-4">
                  <div className="border-b pb-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      (nível 2). As comissões são de 10% para vendas diretas e
                      3% para vendas de seus indicados.
                    </p>
                  </div>
                  ...
                  <div className="border-b pb-4">
                    ...
                    <p className="text-muted-foreground">
                      As comissões são calculadas mensalmente e ficam
                      disponíveis para saque até o dia 10 do mês seguinte. O
                      valor mínimo para saque é de R$ 100,00.
                    </p>
                  </div>
                  ...
                  <div className="border-b pb-4">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      cadastrar através desse link, será automaticamente
                      vinculado à sua rede.
                    </p>
                  </div>
                  ...
                  <div className="border-b pb-4">
                    ...
                    <p className="text-muted-foreground">
                      Oferecemos diversos materiais como banners, textos
                      prontos, e-books, vídeos explicativos e links
                      personalizados. Todos esses materiais estão disponíveis na
                      seção "Materiais".
                    </p>
                  </div>
                  ...
                  <div className="border-b pb-4">
                    ...
                    <p className="text-muted-foreground">
                      No Dashboard você encontra todas as métricas de
                      desempenho, incluindo número de cliques, conversões,
                      vendas e comissões. Na seção "Indicados" você pode ver
                      detalhes específicos de cada cliente ou afiliado que você
                      indicou.
                    </p>
                  </div>
                </div>
